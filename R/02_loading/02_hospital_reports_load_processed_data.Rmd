...
load_hospital_data <- function(prefix) {
  for (year in all_years_hospital_reports) {
    file_path <- here(path_base_hospital_reports_data_reproducible, paste0(prefix, year, ".csv"))
...
df_hospital_location_merged_geocoded <- read_csv(
  here(path_base_hospital_reports_data_reproducible, "df_hospital_location_merged_geocoded.csv"),
