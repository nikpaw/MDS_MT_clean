---
title: "Import and Prepare Geospatial and Regional Typology Data"
...
df_states_geo_simplified <- rmapshaper::ms_simplify(df_states_geo_clean, keep = 0.05, keep_shapes = TRUE)

# Extract shared internal boundaries between states
df_internal_borders <- rmapshaper::ms_innerlines(df_states_geo_simplified)
```
...
# Export as GeoPackage (great for storing multiple layers and preserving geometry)
sf::st_write(df_regiostar_geo, here::here("data", "processed", "geodata", "df_regiostar_geo.gpkg"), delete_dsn = TRUE)
sf::st_write(df_states_geo, here::here("data", "processed", "geodata", "df_states_geo.gpkg"), delete_dsn = TRUE)
sf::st_write(df_states_geo_simplified, here::here("data", "processed", "geodata", "df_states_geo_simplified.gpkg"), delete_dsn = TRUE)
sf::st_write(df_internal_borders, here::here("data", "processed", "geodata", "df_internal_borders.gpkg"), delete_dsn = TRUE)
sf::st_write(states_border_clean_sf, here::here("data", "processed", "geodata", "states_border_clean_sf.gpkg"), delete_dsn = TRUE)
